package gejapao.library.animation;
...
import gejapao.library.animation.FadeAnimation;

import gejapao.library.interfaces.GuillotineListener;
import gejapao.library.util.ActionBarInterpolator;
import gejapao.library.util.GuillotineInterpolator;
...
public class GuillotineAnimation extends FadeAnimation {
     ...
     *
     * BUG:
     * guillotine animation lose itself when isopening or isclosing when click hamburguer more than one time
     *
     * tried: .end, .cancel
     * boolean listener
     *
