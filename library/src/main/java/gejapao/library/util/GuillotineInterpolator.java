...
public class GuillotineInterpolator implements TimeInterpolator {
    ...
    public static final float ROTATION_TIME = 0.47767f;
    public static final float FIRST_BOUNCE_TIME = 0.27666f;
    public static final float SECOND_BOUNCE_TIME = 0.31f;
