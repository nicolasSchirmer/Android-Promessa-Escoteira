...
import schirmer.nicolas.promessaescoteira.GuillotineMenu.Interfaces.GuillotineListener;
import schirmer.nicolas.promessaescoteira.GuillotineMenu.Util.ActionBarInterpolator;
import schirmer.nicolas.promessaescoteira.GuillotineMenu.Util.GuillotineInterpolator;
...
/**
 *  Extended class with fade animation
 */

public class GuillotineAnimation extends FadeAnimation {
     ...
     *
     * BUG:
     * guillotine animation lose itself when isopening or isclosing when click hamburguer
     *
     * tried: .end, .cancel
     * boolean listener
     *
     * most effective if (!isOpening && !isClosing) BUT its not cool effect, need to animation completely finish
     */
