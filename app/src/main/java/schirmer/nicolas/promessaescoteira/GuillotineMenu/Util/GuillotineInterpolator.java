package schirmer.nicolas.promessaescoteira.GuillotineMenu.Util;
...
public class GuillotineInterpolator implements TimeInterpolator {
    ...
    public static final float FIRST_BOUNCE_TIME = 0.2666f;
    public static final float SECOND_BOUNCE_TIME = 0.2666f;
